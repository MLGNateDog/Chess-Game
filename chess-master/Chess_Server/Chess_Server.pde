...
boolean firstClick, yourTurn, canTakeBack, enemyTakeBack, pawnPromotion, opponentPromotion;
...
void setup() {
  ...
  yourTurn = true;
  canTakeBack = false;
  ukey = qkey = kkey = rkey = bkey = false;
}
...
void takeBack() {
  if (canTakeBack && yourTurn == false) {
    if (ukey) {
      ...
      myServer.write(row2 + "," + col2 + "," + row1 + "," + col1 + "," + 1 + "," + 0);
      ukey = false;
      println("TAKEBACK");
      canTakeBack = false;
      yourTurn = true;
...
void promotion() {
  if (pawnPromotion) {
    ...
    if (qkey) {
      grid[row2][col2] = 'q';
      myServer.write(row1 + "," + col1 + "," + row2 + "," + col2 + "," + 0 + "," + 2);
      pawnPromotion = false;
      canTakeBack = false;
      qkey = false;
    }
    ...
    if (kkey) {
      grid[row2][col2] = 'n';
      myServer.write(row1 + "," + col1 + "," + row2 + "," + col2 + "," + 0 + "," + 3);
      pawnPromotion = false;
      canTakeBack = false;
      kkey = false;
    }
    ...
    if (bkey) {
      grid[row2][col2] = 'b';
      myServer.write(row1 + "," + col1 + "," + row2 + "," + col2 + "," + 0 + "," + 4);
      pawnPromotion = false;
      canTakeBack = false;
      bkey = false;
    }
    ...
    if (rkey) {
      grid[row2][col2] = 'r';
      myServer.write(row1 + "," + col1 + "," + row2 + "," + col2 + "," + 0 + "," + 5);
      pawnPromotion = false;
      canTakeBack = false;
      rkey = false;
    }
